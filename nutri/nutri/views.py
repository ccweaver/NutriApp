...
def sign_in(request):
    ...
    if request.method == 'POST':
        ...
        if 'type' in request.POST:
            ...
            cities = ['Stamford', 'Boston', 'Cambridge', 'Phoenix', 'Manhattan', 'Philadelphia']
            neighborhoods = ['Allston', 'Back Bay / South End', 'Beacon Hill / West End', 'North End', 'Cambridgeport', 'Brighton / Brookline', 'Chinatown', 'Charlestown', 'Dorchester', 'East Boston', 'Fenway', 'Financial District', 'Hyde Park', 'Jamaica Plain', 'Mattapan', 'Mission Hill', 'Mobile Food Truck', 'Roslindale', 'Roxbury', 'South Boston', 'Central Square', 'East Cambridge / MIT', 'Harvard Square / Somerville', 'Inman Square', 'Porter Square', 'Cove / East Main Street / Stillwater Ave', 'Downtown Stamford', 'Harbor Point', 'Hope Street', 'Long Ridge / High Ridge / Glenbrook', 'Arcadia', 'Biltmore Area / Desert Ridge', 'Chandler Area', 'Downtown Phoenix / Encanto Village / East Camelback', 'Gilbert Area', 'Glendale Area', 'Maryvale', 'Mesa Area', 'Peoria Area', 'Scottsdale Area', 'South Phoenix', 'Tempe Area', 'Deer Valley', 'Grand Canyon University Area', 'North Mountain Village Area', 'Paradise Valley Village Area', 'Cave Creek / Anthem Area', 'Battery Park', 'Chelsea / Greenwich Village', 'Greenwich Village East', 'East Harlem', 'Midtown East', 'The Financial District', 'Flatiron District', 'Gramercy', 'Harlem', 'Inwood', 'Koreatown','Lower East Side', 'Lower Manhattan', 'Midtown Center', 'Midtown / Upper East Side', 'Morningside Heights', 'Murray Hill', 'Roosevelt Island', 'Soho / Tribeca', 'Sutton Place', 'Theater District', 'Upper East Side', 'Upper West Side', 'NoHo', 'Washington Heights', 'Greenwich Village West', 'Midtown West', 'Yorkville', 'Art Musem / Francisville', 'Belmont / Parkside / Powelton Village', 'Brewerytown', 'Bridesburg', 'Cedarbrook', 'Chestnut Hill', 'East Falls', 'Eastwick', 'Elmwood / Southwest Philadelphia', 'Fishtown / Kensington', 'Frankford', 'Germantown', 'Graduate Hospital / Naval Square / Soutwest Center City', 'Holmsburg', 'Hunting Park', 'Lawndale / Castor Gardens', 'Logan', 'Logan / Olney', 'Manayunk', 'Mount Airy', 'Northern Liberties / Loft District', 'Oak Lane', 'Overbrook / Overbrook Farms / Overbrook Park', 'Parkwood', 'Passyunk', 'Port Richmod', 'Queen Village / Bella Vista / Pennsport / Italian Market', 'Rhawnhurt', 'Rittenhouse Square / Ave of the Arts / Logan Square / Fitler Square', 'Society Hill / Old City', 'Somerton / Bustleton', 'Tacony', 'Torresdale', 'University City', 'Walnut Hill', 'Washington Square West / Midtown Village / Chinatown', 'West Oak Lane', 'Whitman / South Philadelphia', 'Wynnefield', 'Yorktown / Old Kensington / Jinogi']  
            if termType == 'n':
    ...
    if is_user:
        ...
        cities = ['Stamford', 'Boston', 'Cambridge', 'Phoenix', 'Manhattan', 'Philadelphia']
        neighborhoods = ['Allston', 'Back Bay / South End', 'Beacon Hill / West End', 'North End', 'Cambridgeport', 'Brighton / Brookline', 'Chinatown', 'Charlestown', 'Dorchester', 'East Boston', 'Fenway', 'Financial District', 'Hyde Park', 'Jamaica Plain', 'Mattapan', 'Mission Hill', 'Mobile Food Truck', 'Roslindale', 'Roxbury', 'South Boston', 'Central Square', 'East Cambridge / MIT', 'Harvard Square / Somerville', 'Inman Square', 'Porter Square', 'Cove / East Main Street / Stillwater Ave', 'Downtown Stamford', 'Harbor Point', 'Hope Street', 'Long Ridge / High Ridge / Glenbrook', 'Arcadia', 'Biltmore Area / Desert Ridge', 'Chandler Area', 'Downtown Phoenix / Encanto Village / East Camelback', 'Gilbert Area', 'Glendale Area', 'Maryvale', 'Mesa Area', 'Peoria Area', 'Scottsdale Area', 'South Phoenix', 'Tempe Area', 'Deer Valley', 'Grand Canyon University Area', 'North Mountain Village Area', 'Paradise Valley Village Area', 'Cave / Anthem Area', 'Battery Park', 'Chelsea Greenwich Village', 'Downtown', 'East Greenwich Village', 'East Harlem', 'East Midtown', 'Financial District', 'Flatiron District', 'Gramercy', 'Greenwich Village', 'Harlem', 'Inwood', 'Korea Town','Lower East Side', 'Lower Manhattan', 'Midtown', 'Midtown Center', 'Midtown Upper East Side', 'Morningside Heights', 'Murray Hill', 'Roosevelt Island', 'Soho', 'Sutton Place', 'Theater District', 'Tribeca', 'Upper East Side', 'Upper West Side', 'Village NoHo', 'Washington Heights', 'West Greenwich Village', 'West Midtown', 'Yorkville', 'Art Musem / Francisville', 'Belmont / Parkside / Powelton Village', 'Brewerytown', 'Bridesburg', 'Cedarbrook', 'Chestnut Hill', 'East Falls', 'Eastwick', 'Elmwood / Southwest Philadelphia', 'Fishtown / Kensington', 'Frankford', 'Germantown', 'Graduate Hospital / Naval Square / Soutwest Center City', 'Holmsburg', 'Hunting Park', 'Lawndale / Castor Gardens', 'Logan', 'Logan / Olney', 'Manayunk', 'Mount Airy', 'Northern Liberties / Loft District', 'Oak Lane', 'Overbrook / Overbrook Farms / Overbrook Park', 'Parkwood', 'Passyunk', 'Port Richmod', 'Queen Village / Bella Vista / Pennsport / Italian Market', 'Rhawnhurt', 'Rittenhouse Square / Ave of the Arts / Logan Square / Fitler Square', 'Society Hill / Old City', 'Somerton / Bustleton', 'Tacony', 'Torresdale', 'University City', 'Walnut Hill', 'Washington Square West / Midtown Village / Chinatown', 'West Oak Lane', 'Whitman / South Philadelphia', 'Wynnefield', 'Yorktown / Old Kensington / Jinogi']
