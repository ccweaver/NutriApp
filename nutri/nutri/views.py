...
def sign_in(request):
    ...
    if request.method == 'POST':
        ...
        if 'type' in request.POST:
            ...
            top10 = [{'bid':x.rest.id, 'name':x.name, 'likes':x.likes.count(), 'calories':(x.calories/10)*10, 'neighborhood':x.rest.neighborhood, 'restur':x.rest.name, 'city':x.rest.city} for x in i]
